# MSMC
## About:
msmc is a minecraft account checker MADE BY MACHINEKILLER this is just a different version for donutsmp that checks through microsoft xbox login instead of the older mojang login.
